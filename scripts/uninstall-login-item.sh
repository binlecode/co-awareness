#!/bin/bash
# Remove the co-awareness login item — the exact inverse of install-login-item.sh:
...
echo "Note: an instance you launched manually is not affected — stop it with: pkill -f 'CoAwareness'"
